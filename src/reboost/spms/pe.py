...
def detection_probability(
    ...
    """Derive the detection probability of emitted scintillation photons.
    ...
    ph = convolve.iterate_stepwise_depositions_probability(
...
def number_of_detected_photoelectrons(
    ...
    """Derive the number of detected scintillation photons from scintillator hits.
    ...
    hits = ak.Array(
        {
            "num_scint_ph": units_conv_ak(num_scint_ph, "dimensionless"),
            "detp": units_conv_ak(detp, "dimensionless"),
        }
    )

    ph = convolve.iterate_stepwise_depositions_numdet(hits)
    return VectorOfVectors(ph)
