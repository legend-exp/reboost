...
def number_of_detected_photoelectrons(
    ...
    edep_for_stats
        array of deposited energy in scintillation events. Will only be used for statistics.
    max_pes_per_hit
    ...
    edep_for_stats = units_conv_ak(edep_for_stats, "keV") if edep_for_stats is not None else None
