...
hpge_l = hpges.make_hpge("V99999A.yaml", name="V99999A", registry=reg, material=natge)
...
pg4.geant4.PhysicalVolume([0, 0, 0], [0, 0, 0, "m"], hpge_l, "V99999A", world_l, registry=reg)
